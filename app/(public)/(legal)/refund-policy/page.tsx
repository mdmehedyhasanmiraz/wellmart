...
export const metadata = {
  title: "Refund Policy",
  description: "This page outlines the refund policy of Wellmart, detailing how we handle refunds and related information.",
  keywords: ["wellmart", "refund policy", "wellmart refund policy", "wellmart refund policy page"],
  ...
  return (    
    <section className="space-y-6">
      <div className="max-w-3xl mx-auto py-16 px-3 sm:px-8 space-y-4">
        ...
        <p className="">
          Wellmart (“we”, “us”, or “our”) is committed to protecting your refund. This Refund Policy explains how we collect, use, and safeguard your information when you visit our website https://wellmart.com.bd and engage with our services. Please read this policy carefully to understand our practices.
        </p>
        ...
        <h2 className="text-xl md:text-2xl font-semibold">9. Children’s Refund</h2>
        <p className="">
        ...
        <p className="">
          We may update this Refund Policy from time to time. Any changes will be posted on this page with the updated “Last updated” date.
        </p>
